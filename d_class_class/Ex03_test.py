...
1. 파이썬의 클래스와 객체 지향 프로그래밍에 대한 설명으로 틀린 것은? 2
...
____def  __init__(self, name, position, back_number):
...
____def  change_back_number(self, back_number):
...
____def __init__(self, name, characteristic):
...
________return "My name is {0} and my weapon is {1}.".format(self.name, self.characteristic)
...
____def __init__(self, size, year, company):
